...
use App\Http\Controllers\Api\SinhVien\XinMoLopController as SinhVienXinMoLop;
...
use App\Http\Controllers\Api\Admin\XinMoLopController as AdminXinMoLop;
...
Route::middleware(['auth:api', \App\Http\Middleware\CheckActiveUser::class])->group(function () {
    ...
    Route::middleware(['auth:api', 'check.active', 'check.sinhvien'])->prefix('sinh-vien')->group(function () {
        ...
        // Xin mở lớp
        Route::get('xin-mo-lop', [SinhVienXinMoLop::class, 'index']);
        Route::post('xin-mo-lop/store', [SinhVienXinMoLop::class, 'store']);
        Route::post('xin-mo-lop/cancel', [SinhVienXinMoLop::class, 'destroy']);
    });
    ...
    Route::middleware(\App\Http\Middleware\CheckAdmin::class)->prefix('admin')->group(function () {
        ...
        Route::put('thong-bao/{id}', [ThongBaoAdmin::class, 'update']);
        Route::delete('thong-bao/{id}', [ThongBaoAdmin::class, 'destroy']);
        ...
        Route::get('/xin-mo-lop', [AdminXinMoLop::class, 'index']);
        Route::post('/xin-mo-lop/{nhomId}/approve', [AdminXinMoLop::class, 'approve']);
    });
});